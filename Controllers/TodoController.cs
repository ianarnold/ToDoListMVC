...
using ToDoListLoginRegister.Data;
using ToDoListLoginRegister.Models;
using Microsoft.AspNetCore.Authorization;

namespace ToDoListLoginRegister.Controllers
{

    [Authorize] // Autorizacao dos metodos
    public class TodoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            .AsNoTracking()
            .Where(x => x.User == User.Identity.Name)  // Retorna as tarefas apenas quando o usuario logado é quem esta tentando acessar
            .ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Done,CreatedAt,LastUpdateDate,User")] Todo todo)
        {
            if (ModelState.IsValid)
            {
                ...
                todo.User = User.Identity.Name; // Coloca o usuario como o criador da tarefa
